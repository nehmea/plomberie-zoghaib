...
// 2. Dynamically load the Google Translate script, specifying the callback.
...
const translations = {
  fr: {
    ...
    missionText:
      "Bienvenue à votre destination de confiance pour des solutions de plomberie à Montréal. Que vous ayez besoin de services résidentiels ou commerciaux, nous sommes là pour vous fournir des solutions fiables et efficaces adaptées à vos besoins.",
    ...
    "footer-text": "©2024 Tuyau Magique",
  },
  en: {
    title: "Magic pipe",
    navAbout: "About Us",
    ...
    missionText:
      "Welcome to your trusted destination for plumbing solutions in Montreal. Whether you need residential or commercial services, we are here to provide reliable and efficient solutions tailored to your needs",
